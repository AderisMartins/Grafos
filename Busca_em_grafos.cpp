...
void criaGrafoExemplo()
{
	...
	insereAresta(grafo, 4, 14);
	insereAresta(grafo, 5, 6);
	insereAresta(grafo, 5, 15);
	insereAresta(grafo, 6, 15);	
	insereAresta(grafo, 7, 8);
	insereAresta(grafo, 7, 9);
	insereAresta(grafo, 8, 10);
	insereAresta(grafo, 8, 14);
	insereAresta(grafo, 9, 10);
	insereAresta(grafo, 9, 11);
	insereAresta(grafo, 10, 12);
	insereAresta(grafo, 11, 12);
	insereAresta(grafo, 11, 13);
	insereAresta(grafo, 12, 14);
	insereAresta(grafo, 14, 16);
	insereAresta(grafo, 15, 16);
}
